...
//
//  Created by Tirupathi Mandali on 10/21/21.
//

import UIKit

public class CustomeAlert: UIView {
    ...
    @IBOutlet public weak var alertBaseView: UIView!
    @IBOutlet public weak var buttonsStack: UIStackView!
    
    private let nibName = String(describing: CustomeAlert.self)
